...
export const SuccessDeleteMessage: React.FunctionComponent<SuccessMessageProps> = ({ onCloseDialog }) => {
    ...
    return (
        <>
            <DefaultButton secondaryText="Opens the Sample Dialog" onClick={toggleHideMessage} text="Excluir" styles={buttonStyles} />
            <Dialog
                hidden={hideDialog}
                onDismiss={() => {
                    toggleHideMessage();
